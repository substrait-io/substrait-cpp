...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/usr/bin/git" --git-dir=.git for-each-ref
              "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY
        "/home/davids/projects/substrait-cpp/build-Debug/_deps/date_src-src"
      OUTPUT_VARIABLE upstream_branch
      OUTPUT_STRIP_TRAILING_WHITESPACE COMMAND_ERROR_IS_FATAL
      ANY # There is no error if no upstream is set
    )
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(
        FATAL_ERROR
          "\nFailed to rebase in: '/home/davids/projects/substrait-cpp/build-Debug/_deps/date_src-src'."
    ...
    set(error_log_file
        ${CMAKE_CURRENT_LIST_DIR}/rebase_error_${tag_timestamp}Z.log)
    ...
    execute_process(
      COMMAND
        "/usr/bin/git" --git-dir=.git tag -a -m
        "ExternalProject attempting to move from here to ${checkout_name}"
        ${tag_name}
      WORKING_DIRECTORY
        "/home/davids/projects/substrait-cpp/build-Debug/_deps/date_src-src"
        COMMAND_ERROR_IS_FATAL ANY)
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(
        FATAL_ERROR
          "\nFailed to unstash changes in: '/home/davids/projects/substrait-cpp/build-Debug/_deps/date_src-src'."
          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
