...
#ifndef GOOGLE_PROTOBUF_INCLUDED_substrait_2fproto_2fcapabilities_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_substrait_2fproto_2fcapabilities_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_substrait_2fproto_2fcapabilities_2eproto
...
struct TableStruct_substrait_2fproto_2fcapabilities_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_substrait_2fproto_2fcapabilities_2eproto;
namespace substrait {
namespace proto {
class Capabilities;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::substrait::proto::Capabilities* Arena::CreateMaybeMessage<::substrait::proto::Capabilities>(Arena*);
template<> ::substrait::proto::Capabilities_SimpleExtension* Arena::CreateMaybeMessage<::substrait::proto::Capabilities_SimpleExtension>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace substrait {
namespace proto {
...
class Capabilities_SimpleExtension PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:substrait.proto.Capabilities.SimpleExtension) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "substrait.proto.Capabilities.SimpleExtension";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_substrait_2fproto_2fcapabilities_2eproto);
    return ::descriptor_table_substrait_2fproto_2fcapabilities_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:substrait.proto.Capabilities.SimpleExtension)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_substrait_2fproto_2fcapabilities_2eproto;
};
// -------------------------------------------------------------------

class Capabilities PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:substrait.proto.Capabilities) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "substrait.proto.Capabilities";
  }
  protected:
  ...
  ::substrait::proto::Capabilities_SimpleExtension* mutable_simple_extensions(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::substrait::proto::Capabilities_SimpleExtension >*
      mutable_simple_extensions();
  private:
  const ::substrait::proto::Capabilities_SimpleExtension& _internal_simple_extensions(int index) const;
  ::substrait::proto::Capabilities_SimpleExtension* _internal_add_simple_extensions();
  public:
  const ::substrait::proto::Capabilities_SimpleExtension& simple_extensions(int index) const;
  ::substrait::proto::Capabilities_SimpleExtension* add_simple_extensions();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::substrait::proto::Capabilities_SimpleExtension >&
      simple_extensions() const;

  // @@protoc_insertion_point(class_scope:substrait.proto.Capabilities)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::substrait::proto::Capabilities_SimpleExtension > simple_extensions_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_substrait_2fproto_2fcapabilities_2eproto;
};
// ===================================================================
...
inline const std::string& Capabilities_SimpleExtension::uri() const {
  // @@protoc_insertion_point(field_get:substrait.proto.Capabilities.SimpleExtension.uri)
  return _internal_uri();
}
inline void Capabilities_SimpleExtension::set_uri(const std::string& value) {
  _internal_set_uri(value);
  // @@protoc_insertion_point(field_set:substrait.proto.Capabilities.SimpleExtension.uri)
}
inline std::string* Capabilities_SimpleExtension::mutable_uri() {
  // @@protoc_insertion_point(field_mutable:substrait.proto.Capabilities.SimpleExtension.uri)
...
inline void Capabilities_SimpleExtension::set_uri(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:substrait.proto.Capabilities.SimpleExtension.uri)
}
inline void Capabilities_SimpleExtension::set_uri(const char* value) {
  ...
  uri_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:substrait.proto.Capabilities.SimpleExtension.uri)
}
inline void Capabilities_SimpleExtension::set_uri(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:substrait.proto.Capabilities.SimpleExtension.uri)
}
...
inline std::string* Capabilities_SimpleExtension::release_uri() {
  // @@protoc_insertion_point(field_release:substrait.proto.Capabilities.SimpleExtension.uri)
...
inline void Capabilities_SimpleExtension::set_allocated_uri(std::string* uri) {
  ...
  uri_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), uri,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:substrait.proto.Capabilities.SimpleExtension.uri)
}
inline std::string* Capabilities_SimpleExtension::unsafe_arena_release_uri() {
  // @@protoc_insertion_point(field_unsafe_arena_release:substrait.proto.Capabilities.SimpleExtension.uri)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return uri_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Capabilities_SimpleExtension::unsafe_arena_set_allocated_uri(
    std::string* uri) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (uri != nullptr) {
  ...
  uri_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      uri, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:substrait.proto.Capabilities.SimpleExtension.uri)
}
...
inline std::string* Capabilities_SimpleExtension::add_function_keys() {
  // @@protoc_insertion_point(field_add_mutable:substrait.proto.Capabilities.SimpleExtension.function_keys)
...
inline const std::string& Capabilities_SimpleExtension::function_keys(int index) const {
  // @@protoc_insertion_point(field_get:substrait.proto.Capabilities.SimpleExtension.function_keys)
  return _internal_function_keys(index);
}
inline std::string* Capabilities_SimpleExtension::mutable_function_keys(int index) {
  // @@protoc_insertion_point(field_mutable:substrait.proto.Capabilities.SimpleExtension.function_keys)
...
inline void Capabilities_SimpleExtension::set_function_keys(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:substrait.proto.Capabilities.SimpleExtension.function_keys)
...
inline void Capabilities_SimpleExtension::set_function_keys(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  function_keys_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:substrait.proto.Capabilities.SimpleExtension.function_keys)
}
inline void Capabilities_SimpleExtension::set_function_keys(int index, const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:substrait.proto.Capabilities.SimpleExtension.function_keys)
}
...
inline void Capabilities_SimpleExtension::add_function_keys(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:substrait.proto.Capabilities.SimpleExtension.function_keys)
}
...
inline void Capabilities_SimpleExtension::add_function_keys(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  function_keys_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:substrait.proto.Capabilities.SimpleExtension.function_keys)
}
inline void Capabilities_SimpleExtension::add_function_keys(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:substrait.proto.Capabilities.SimpleExtension.function_keys)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Capabilities_SimpleExtension::function_keys() const {
  // @@protoc_insertion_point(field_list:substrait.proto.Capabilities.SimpleExtension.function_keys)
  return function_keys_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Capabilities_SimpleExtension::mutable_function_keys() {
  // @@protoc_insertion_point(field_mutable_list:substrait.proto.Capabilities.SimpleExtension.function_keys)
  return &function_keys_;
}
...
inline std::string* Capabilities_SimpleExtension::add_type_keys() {
  // @@protoc_insertion_point(field_add_mutable:substrait.proto.Capabilities.SimpleExtension.type_keys)
...
inline const std::string& Capabilities_SimpleExtension::type_keys(int index) const {
  // @@protoc_insertion_point(field_get:substrait.proto.Capabilities.SimpleExtension.type_keys)
  return _internal_type_keys(index);
}
inline std::string* Capabilities_SimpleExtension::mutable_type_keys(int index) {
  // @@protoc_insertion_point(field_mutable:substrait.proto.Capabilities.SimpleExtension.type_keys)
  return type_keys_.Mutable(index);
}
inline void Capabilities_SimpleExtension::set_type_keys(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:substrait.proto.Capabilities.SimpleExtension.type_keys)
...
inline void Capabilities_SimpleExtension::set_type_keys(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  type_keys_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:substrait.proto.Capabilities.SimpleExtension.type_keys)
}
inline void Capabilities_SimpleExtension::set_type_keys(int index, const char* value, size_t size) {
  type_keys_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:substrait.proto.Capabilities.SimpleExtension.type_keys)
}
...
inline void Capabilities_SimpleExtension::add_type_keys(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:substrait.proto.Capabilities.SimpleExtension.type_keys)
}
...
inline void Capabilities_SimpleExtension::add_type_keys(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  type_keys_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:substrait.proto.Capabilities.SimpleExtension.type_keys)
}
inline void Capabilities_SimpleExtension::add_type_keys(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:substrait.proto.Capabilities.SimpleExtension.type_keys)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Capabilities_SimpleExtension::type_keys() const {
  // @@protoc_insertion_point(field_list:substrait.proto.Capabilities.SimpleExtension.type_keys)
  return type_keys_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Capabilities_SimpleExtension::mutable_type_keys() {
  // @@protoc_insertion_point(field_mutable_list:substrait.proto.Capabilities.SimpleExtension.type_keys)
  return &type_keys_;
}
...
inline std::string* Capabilities_SimpleExtension::add_type_variation_keys() {
  // @@protoc_insertion_point(field_add_mutable:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
...
inline const std::string& Capabilities_SimpleExtension::type_variation_keys(int index) const {
  // @@protoc_insertion_point(field_get:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
...
inline std::string* Capabilities_SimpleExtension::mutable_type_variation_keys(int index) {
  // @@protoc_insertion_point(field_mutable:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
...
inline void Capabilities_SimpleExtension::set_type_variation_keys(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
...
inline void Capabilities_SimpleExtension::set_type_variation_keys(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  type_variation_keys_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
}
inline void Capabilities_SimpleExtension::set_type_variation_keys(int index, const char* value, size_t size) {
  type_variation_keys_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
}
...
inline void Capabilities_SimpleExtension::add_type_variation_keys(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
}
...
inline void Capabilities_SimpleExtension::add_type_variation_keys(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  type_variation_keys_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
}
inline void Capabilities_SimpleExtension::add_type_variation_keys(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Capabilities_SimpleExtension::type_variation_keys() const {
  // @@protoc_insertion_point(field_list:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
  return type_variation_keys_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Capabilities_SimpleExtension::mutable_type_variation_keys() {
  // @@protoc_insertion_point(field_mutable_list:substrait.proto.Capabilities.SimpleExtension.type_variation_keys)
  return &type_variation_keys_;
}
...
inline std::string* Capabilities::add_substrait_versions() {
  // @@protoc_insertion_point(field_add_mutable:substrait.proto.Capabilities.substrait_versions)
...
inline const std::string& Capabilities::substrait_versions(int index) const {
  // @@protoc_insertion_point(field_get:substrait.proto.Capabilities.substrait_versions)
  return _internal_substrait_versions(index);
}
inline std::string* Capabilities::mutable_substrait_versions(int index) {
  // @@protoc_insertion_point(field_mutable:substrait.proto.Capabilities.substrait_versions)
  return substrait_versions_.Mutable(index);
}
inline void Capabilities::set_substrait_versions(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:substrait.proto.Capabilities.substrait_versions)
...
inline void Capabilities::set_substrait_versions(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  substrait_versions_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:substrait.proto.Capabilities.substrait_versions)
}
inline void Capabilities::set_substrait_versions(int index, const char* value, size_t size) {
  substrait_versions_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:substrait.proto.Capabilities.substrait_versions)
}
...
inline void Capabilities::add_substrait_versions(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:substrait.proto.Capabilities.substrait_versions)
}
...
inline void Capabilities::add_substrait_versions(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  substrait_versions_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:substrait.proto.Capabilities.substrait_versions)
}
inline void Capabilities::add_substrait_versions(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:substrait.proto.Capabilities.substrait_versions)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Capabilities::substrait_versions() const {
  // @@protoc_insertion_point(field_list:substrait.proto.Capabilities.substrait_versions)
  return substrait_versions_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Capabilities::mutable_substrait_versions() {
  // @@protoc_insertion_point(field_mutable_list:substrait.proto.Capabilities.substrait_versions)
  return &substrait_versions_;
}
...
inline std::string* Capabilities::add_advanced_extension_type_urls() {
  // @@protoc_insertion_point(field_add_mutable:substrait.proto.Capabilities.advanced_extension_type_urls)
...
inline const std::string& Capabilities::advanced_extension_type_urls(int index) const {
  // @@protoc_insertion_point(field_get:substrait.proto.Capabilities.advanced_extension_type_urls)
...
inline std::string* Capabilities::mutable_advanced_extension_type_urls(int index) {
  // @@protoc_insertion_point(field_mutable:substrait.proto.Capabilities.advanced_extension_type_urls)
...
inline void Capabilities::set_advanced_extension_type_urls(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:substrait.proto.Capabilities.advanced_extension_type_urls)
...
inline void Capabilities::set_advanced_extension_type_urls(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  advanced_extension_type_urls_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:substrait.proto.Capabilities.advanced_extension_type_urls)
}
inline void Capabilities::set_advanced_extension_type_urls(int index, const char* value, size_t size) {
  advanced_extension_type_urls_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:substrait.proto.Capabilities.advanced_extension_type_urls)
}
...
inline void Capabilities::add_advanced_extension_type_urls(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:substrait.proto.Capabilities.advanced_extension_type_urls)
}
...
inline void Capabilities::add_advanced_extension_type_urls(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  advanced_extension_type_urls_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:substrait.proto.Capabilities.advanced_extension_type_urls)
}
inline void Capabilities::add_advanced_extension_type_urls(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:substrait.proto.Capabilities.advanced_extension_type_urls)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Capabilities::advanced_extension_type_urls() const {
  // @@protoc_insertion_point(field_list:substrait.proto.Capabilities.advanced_extension_type_urls)
  return advanced_extension_type_urls_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Capabilities::mutable_advanced_extension_type_urls() {
  // @@protoc_insertion_point(field_mutable_list:substrait.proto.Capabilities.advanced_extension_type_urls)
  return &advanced_extension_type_urls_;
}
...
inline ::substrait::proto::Capabilities_SimpleExtension* Capabilities::mutable_simple_extensions(int index) {
  // @@protoc_insertion_point(field_mutable:substrait.proto.Capabilities.simple_extensions)
  return simple_extensions_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::substrait::proto::Capabilities_SimpleExtension >*
Capabilities::mutable_simple_extensions() {
  // @@protoc_insertion_point(field_mutable_list:substrait.proto.Capabilities.simple_extensions)
  return &simple_extensions_;
}
inline const ::substrait::proto::Capabilities_SimpleExtension& Capabilities::_internal_simple_extensions(int index) const {
  return simple_extensions_.Get(index);
}
inline const ::substrait::proto::Capabilities_SimpleExtension& Capabilities::simple_extensions(int index) const {
  // @@protoc_insertion_point(field_get:substrait.proto.Capabilities.simple_extensions)
  return _internal_simple_extensions(index);
}
inline ::substrait::proto::Capabilities_SimpleExtension* Capabilities::_internal_add_simple_extensions() {
  return simple_extensions_.Add();
}
inline ::substrait::proto::Capabilities_SimpleExtension* Capabilities::add_simple_extensions() {
  // @@protoc_insertion_point(field_add:substrait.proto.Capabilities.simple_extensions)
  return _internal_add_simple_extensions();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::substrait::proto::Capabilities_SimpleExtension >&
Capabilities::simple_extensions() const {
  // @@protoc_insertion_point(field_list:substrait.proto.Capabilities.simple_extensions)
  return simple_extensions_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_substrait_2fproto_2fcapabilities_2eproto
