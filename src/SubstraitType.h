...
class SubstraitDecimalType
 ...
 public:
  ...
  SubstraitDecimalType(const int precision, const int scale)
      : SubstraitDecimalType(std::to_string(precision), std::to_string(scale)) {
  }
...
class SubstraitFixedBinaryType
 ...
 public:
  ...
  SubstraitFixedBinaryType(const int length)
      : SubstraitFixedBinaryType(std::make_shared<SubstraitStringLiteralType>(
...
class SubstraitFixedCharType
 ...
 public:
  ...
  SubstraitFixedCharType(const int length)
      : SubstraitFixedCharType(std::make_shared<SubstraitStringLiteralType>(
            std::to_string(length))) {}
...
class SubstraitVarcharType
 ...
 public:
  ...
  SubstraitVarcharType(const int length)
      : SubstraitVarcharType(std::make_shared<SubstraitStringLiteralType>(
            std::to_string(length))) {}
...
class SubstraitListType : public SubstraitTypeBase<SubstraitTypeKind ::kList> {
 public:
  SubstraitListType(const SubstraitTypePtr& elementType)
      : elementType_(elementType){};

  const SubstraitTypePtr elementType() const {
    return elementType_;
  }
